...
eulers_num = Button(root, button_params, text='e',command=lambda:btn_click(str(math.exp(1)))).grid(row=1, column=4, sticky="nsew")
...
command=lambda:btn_click('**3')).grid(row=3, column=1, sticky="nsew")
...
percentage = Button(root, button_params, text='%',command=percent).grid(row=5, column=3, sticky="nsew")
